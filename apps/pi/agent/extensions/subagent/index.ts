...
const TasksArray = Type.Array(TaskItem, {
	description: `Array of {agent, task} for parallel execution (max ${MAX_PARALLEL_TASKS} tasks, ${MAX_CONCURRENCY} concurrent)`,
});
...
const SubagentParams = Type.Object({
	...
	tasks: Type.Optional(TasksArray),
...
export default function (pi: ExtensionAPI) {
	pi.registerTool({
		...
		description: [
			...
			"Parallel mode: max 8 tasks total, 4 concurrent executions.",
