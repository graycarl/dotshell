<!-- 由 scripts/sync-upstream.sh 从 mowenxd/cli 的 skills/mo-auth/SKILL.md 生成，请勿手工编辑。 -->
...
| 字段 | 类型 | 说明 | 引用字段 |
|------|------|------|------|
| `auth` | object | 认证信息 | [`AuthInfo - 认证信息`](output-schema.md#auth-info) |
| `profile` | object | 用户在墨问平台上的 Profile(用户信息) | [`UserInfo - 用户信息`](output-schema.md#user-info) |
